...
public final class SendDocumentParameters {
  ...
  public static final class Builder {
    ...
    private SendDocumentParameters buildingType;

    public Builder() {
      buildingType = new SendDocumentParameters();
    }
    ...
    public Builder setDocument(InputFile document) {
    ...
    public SendDocumentParameters build() {
      return buildingType;
    }
  }
