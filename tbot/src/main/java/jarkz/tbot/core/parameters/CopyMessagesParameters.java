...
public final class CopyMessagesParameters {
  ...
  public static final class Builder {
    ...
    private CopyMessagesParameters buildingType;

    public Builder() {
      buildingType = new CopyMessagesParameters();
    }
    ...
    public Builder setRemoveCaption(Boolean removeCaption) {
      buildingType.removeCaption = removeCaption;
      return this;
    }

    public CopyMessagesParameters build() {
      return buildingType;
    }
  }
