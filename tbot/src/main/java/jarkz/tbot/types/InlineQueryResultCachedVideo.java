...
public final class InlineQueryResultCachedVideo implements InlineQueryResult {
  ...
  public static final class Builder {
    ...
    private InlineQueryResultCachedVideo buildingType;

    public Builder() {
      buildingType = new InlineQueryResultCachedVideo();
    }
    ...
    public Builder setVideoFileId(String videoFileId) {
      buildingType.videoFileId = videoFileId;
      return this;
    }
