...
public class KeyboardButton {
	...
	public String toString() {
		...
		builder.append("KeyboardButton[text=").append(text)
				.append(", requestUser=").append(requestUser)
				.append(", requestChat=").append(requestChat)
				.append(", requestContact=").append(requestContact)
				.append(", requestLocation=").append(requestLocation)
				.append(", requestPoll=").append(requestPoll)
