...
public class ResponseParameters {
	...
	public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof ResponseParameters other))
			return false;
		return Objects.equals(migrateToChatId, other.migrateToChatId) && Objects.equals(retryAfter, other.retryAfter);
	}

	@Override
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("ResponseParameters[migrateToChatId=").append(migrateToChatId)
				.append(", retryAfter=").append(retryAfter).append("]");
