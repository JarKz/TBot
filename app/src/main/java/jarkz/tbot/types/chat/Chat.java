...
public class Chat {
	...
	public boolean equals(Object obj) {
		...
		return id == other.id && Objects.equals(type, other.type)
				...
				&& Objects.equals(hasRestrictedVoiceAndVideoMessages, other.hasRestrictedVoiceAndVideoMessages)
	...
	public String toString() {
		...
		builder.append("Chat[id=").append(id)
				.append(", type=").append(type)
				.append(", title=").append(title)
				.append(", username=").append(username)
				.append(", firstName=").append(firstName)
				.append(", lastName=").append(lastName)
				.append(", isForum=").append(isForum)
				.append(", photo=").append(photo)
				.append(", activeUsernames=").append(activeUsernames)
				.append(", emojiStatusCustomEmojiId=").append(emojiStatusCustomEmojiId)
				.append(", bio=").append(bio)
				.append(", hasPrivateForwards=").append(hasPrivateForwards)
				.append(", hasRestrictedVoiceAndVideoMessages=").append(hasRestrictedVoiceAndVideoMessages)
				.append(", joinToSendMessages=").append(joinToSendMessages)
				.append(", joinByRequest=").append(joinByRequest)
				.append(", description=").append(description)
				.append(", inviteLink=").append(inviteLink)
				.append(", pinnedMessage=").append(pinnedMessage)
				.append(", permissions=").append(permissions)
				.append(", slowModeDelay=").append(slowModeDelay)
				.append(", messageAutoDeleteTime=").append(messageAutoDeleteTime)
				.append(", hasAggressiveAntiSpamEnabled=").append(hasAggressiveAntiSpamEnabled)
				.append(", hasHiddenMembers=").append(hasHiddenMembers)
				.append(", hasProtectedContent=").append(hasProtectedContent)
				.append(", stickerSetName=").append(stickerSetName)
				.append(", canSetStickerSet=").append(canSetStickerSet)
				.append(", linkedChatId=").append(linkedChatId)
