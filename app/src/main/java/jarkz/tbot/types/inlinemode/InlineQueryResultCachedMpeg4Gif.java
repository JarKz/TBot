...
public class InlineQueryResultCachedMpeg4Gif implements InlineQueryResult {
	...
	final public boolean equals(Object obj) {
		if (this == obj)
			return true;
		if (!(obj instanceof InlineQueryResultCachedMpeg4Gif other))
			return false;
	...
	public String toString() {
		...
		builder.append("InlineQueryResultCachedMpeg4Gif[type=").append(type)
				.append(", id=").append(id)
				.append(", mpeg4FileId=").append(mpeg4FileId)
