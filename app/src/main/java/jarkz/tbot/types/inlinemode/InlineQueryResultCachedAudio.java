 ...
 * file will be sent by the user. Alternatively, you can use <i>input_message_content</i> to send a
...
public class InlineQueryResultCachedAudio implements InlineQueryResult {
  ...
  /**
   * Check whether a inline query audio is cached or not.
   *
   ...
   *
   * @return audio_file_id as String.
   */
  ...
  /**
   * Sets the valid file identifier for the audio file.
   *
   * @param audioFileId the valid file identifier for the audio file as String.
   */
  ...
  public final boolean equals(Object obj) {
    ...
    if (!(obj instanceof InlineQueryResultCachedAudio other)) return false;
  ...
  public String toString() {
    ...
    builder
        .append("InlineQueryResultCachedAudio[type=")
        .append(type)
        .append(", id=")
        .append(id)
        .append(", audioFileId=")
