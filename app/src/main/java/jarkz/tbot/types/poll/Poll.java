...
public class Poll {
	...
	public String toString() {
		...
		builder.append("Poll[id=").append(id)
				.append(", question=").append(question)
				.append(", options=").append(options)
				.append(", totalVoterCount=").append(totalVoterCount)
				.append(", isClosed=").append(isClosed)
				.append(", isAnonymous=").append(isAnonymous)
				.append(", type=").append(type)
				.append(", allowsMultipleAnswers=").append(allowsMultipleAnswers)
				.append(", correctOptionId=").append(correctOptionId)
				.append(", explanation=").append(explanation)
				.append(", explanationEntities=").append(explanationEntities)
				.append(", openPeriod=").append(openPeriod)
